...
from models.pspnet_training import weights_init
from utils.callbacks import LossHistory
from utils.dataloader import PSPnetDataset, pspnet_dataset_collate
from utils.utils_fit import fit_one_epoch, fit_one_epoch_rgb
import dataloader_utils
import dataloader_utils2
...
if __name__ == "__main__":
    ...
    if True:
        ...
        gen, gen_val = dataloader_utils2.get_dataloader('./LMC/lmc_askap_aconf.fits')
        epoch_step = len(gen)
